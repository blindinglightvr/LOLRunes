...
IL_Add(ImageListID1, "caitlyn.png", 0xFFFFFF, 1) 
IL_Add(ImageListID1, "diana.png", 0xFFFFFF, 1) 
IL_Add(ImageListID1, "kayn.png", 0xFFFFFF, 1)
IL_Add(ImageListID1, "missfortune.png", 0xFFFFFF, 1) 
IL_Add(ImageListID1, "rammus.png", 0xFFFFFF, 1) 
IL_Add(ImageListID1, "thresh.png", 0xFFFFFF, 1) 
IL_Add(ImageListID1, "udyr.png", 0xFFFFFF, 1) 
IL_Add(ImageListID1, "yasuo.png", 0xFFFFFF, 1) 

IL_Add(ImageListID2, "caitlyn.png", 0xFFFFFF, 1) 
IL_Add(ImageListID2, "diana.png", 0xFFFFFF, 1) 
IL_Add(ImageListID2, "kayn.png", 0xFFFFFF, 1) 
IL_Add(ImageListID2, "missfortune.png",0xFFFFFF, 1) 
IL_Add(ImageListID2, "rammus.png", 0xFFFFFF, 1) 
IL_Add(ImageListID2, "thresh.png", 0xFFFFFF, 1) 
IL_Add(ImageListID2, "udyr.png", 0xFFFFFF, 1) 
IL_Add(ImageListID2, "yasuo.png", 0xFFFFFF, 1) 


LV_Add("Icon" . 1, " Caitlyn", "Caitlyn")
LV_Add("Icon" . 2, " Diana", "Diana")
LV_Add("Icon" . 3, " Kayn", "Kayn")
LV_Add("Icon" . 4, " Miss Fortune", "Miss Fortune")
LV_Add("Icon" . 5, " Rammus", "Rammus")
LV_Add("Icon" . 6, " Thresh", "Thresh")
LV_Add("Icon" . 7, " Udyr", "Udyr")
LV_Add("Icon" . 8, " Yasuo", "Yasuo")
