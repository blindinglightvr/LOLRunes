...
setRune(type, rune, col, row){
	...
	GuiControlGet, role
	if (%firstRun% = true){
		ClickWait(1016,1233) ;Click mastery drop-down list
...
; https://autohotkey.com/board/topic/95907-remove-horizontal-scroll-bar-in-listview/
...
champArray := {Alister: "alister.png", Caitlyn: "caitlyn.png", Diana: "diana.png", Graves: "graves.png", KaiSa: "kaisa.png", Kayn: "kayn.png", "Kogmaw": "kogmaw.png", "Miss Fortune": "missfortune.png", Nunu: "nunu.png", Rammus: "rammus.png", Sivir: "sivir.png", Thresh: "thresh.png", Udyr: "udyr.png", Vayne: "vayne.png", Yasuo: "yasuo.png"}
...
LV_ModifyCol(1, 20)  ; Size column 1 to fit its contents, no parameters auto-sizes all columns.
LV_ModifyCol(2, 119) ; Size column 2 to fit its contents, no parameters auto-sizes all columns.

Gui, 1: Add, Picture, x0 y0 w400 +0x4000000, background3grey.png
Gui, 1: Font, cFFFFFF
Gui, 1: Add, Text, x180 y10 +BackgroundTrans, Role
Gui, 1: Add, ListBox, x180 y24 h70 w110 c0000FF vrole grole, Mid||Top|Jungle|ADC|Support
Gui, 1: Add, Text, x180 y95 BackgroundTrans, Type
Gui, 1: Add, DropDownList, x180 y110 w70 h70 vtype, Default||vs AP|vs AD|vs Burst
...
{	
	RowNum := LV_GetNext(0,"Focused") ;gets selected row number
	if (RowNum != 0){
		LV_GetText(champ, RowNum, 2)  ; Get the text from the row's second field.	
		%champ%()	
	}
}
return
